...
public class ListaFilmesPresenter implements ListaItemContrato.ListaFilmesPresenter {

    private ListaItemContrato.ListaFilmesView view;

    public ListaFilmesPresenter(ListaItemContrato.ListaFilmesView view) {
        this.view = view;
    }
